...
template <typename float_u, typename float_v, typename float_>
 void inline ScaleAndAdd(SVector<float_u> &u, SVector<float_v> const &v, float_ const& s) {
  float_u * const __restrict__ uvals = u.values;
  float_u * const __restrict__ uidx = u.index;
  float_v const * const __restrict__ vvals = v.values;
  int const * const __restrict__ vidx = v.index;
  int cur_idx;
  for (size_t i = 0; i<v.size; i++) {
...
void inline StoS(SVector<float_u> &u, SVector<float_v> &v, double const& s) {
  float_u * const __restrict__ uvals = u.values;
  int const * const __restrict__ uidx = u.index;
  float_v const * const __restrict__ vvals = v.values;
  int const * const __restrict__ vidx = v.index;
